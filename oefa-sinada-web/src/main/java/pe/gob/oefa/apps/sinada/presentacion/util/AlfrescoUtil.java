...
private static String logBase = "oefa-sinada-core: WsCmsCliente - web";
	
	private final static Logger logger = Logger.getLogger("pe.gob.oefa.apps.sinada.presentacion.util.AlfrescoUtil");
