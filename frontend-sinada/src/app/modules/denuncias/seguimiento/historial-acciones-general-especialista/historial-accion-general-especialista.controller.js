(function() {
	...
	.controller('HistorialAccionGeneralEspecialistaController',HistorialAccionGeneralEspecialistaController);


	/** @ngInject */
	function HistorialAccionGeneralEspecialistaController($scope,$state, toastr, ngDialog,MaestroFactory,InformeAccionFactory,$filter,BandejaFactory,$rootScope,AtencionDenuncia, EvaluacionRechazoFactory,EvaluacionInformeFactory) {
		var vm = this;
