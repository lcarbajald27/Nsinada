(function() {
    'use strict';
    angular.module('spapp').controller('DialogEncuestaRevisionController', DialogEncuestaRevisionController);
    /* @ngInject */
    function DialogEncuestaRevisionController(API_CONFIG, $state, $controller, $scope, toastr, ngDialog, AtencionDenuncia, BandejaFactory, MaestroFactory, EncuestaFactory) {
        var vm = this;
...
*/
        ...
        function terminarEncuesta() {
            vm.dataEncuestaRevision.tipoEncuesta.codigoRegistro = 2;
            vm.dataEncuestaRevision.idDenuncia = vm.dataDenuncia.idDenuncia;
