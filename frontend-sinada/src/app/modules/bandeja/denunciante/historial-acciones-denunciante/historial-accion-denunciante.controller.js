(function() {
	...
	.controller('HistorialAccionDenuncianteController',HistorialAccionDenuncianteController);


	/** @ngInject */
	function HistorialAccionDenuncianteController($scope,$state, toastr, ngDialog,MaestroFactory,InformeAccionFactory,$filter,BandejaFactory,$rootScope,AtencionDenuncia, EvaluacionRechazoFactory,EvaluacionInformeFactory) {
		var vm = this;
...
//			debugger;
			if($rootScope.dataDenunciaHistorialDenunciante!= null){
					
					vm.dataDenunciaBandeja = $rootScope.dataDenunciaHistorialDenunciante;
