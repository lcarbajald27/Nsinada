(function() {
	...
	.controller('HistorialAccionController',HistorialAccionController);


	/** @ngInject */
	function HistorialAccionController($scope,$state, toastr, ngDialog,MaestroFactory,InformeAccionFactory,$filter,BandejaFactory,$rootScope,AtencionDenuncia, EvaluacionRechazoFactory,EvaluacionInformeFactory) {
		var vm = this;
		...
		/*	function listarAccionesRegistradas(){
			...
			function listarAccionesRegistradas(){
					...
					var data ={
								...
								idBandejaDetalle : 	vm.dataDenunciaBandeja.idBandejaDetalle,
							}
	 ...
	 function registrarAtencion()
       {		
		...
		function init() {
			...
			if($rootScope.dataDenunciaHistorial!= null){

					vm.dataDenunciaBandeja = $rootScope.dataDenunciaHistorial;
