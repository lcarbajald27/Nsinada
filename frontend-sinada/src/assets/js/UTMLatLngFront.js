var UTMConverter = (function(){
    ...
    var toLatLon = function (easting, northing, zoneNum, zoneLetter, northern, strict) {
    ...
    var fromLatLon = function (latitude, longitude, forceZoneNum) {
    ...
    var latitudeToZoneLetter = function (latitude) {
    ...
    var latLonToZoneNumber = function (latitude, longitude) {
    ...
    var zoneNumberToCentralLongitude = function (zoneNum) {
    ...
    return {
        toLatLon: function(x, y, zoneNumber, north){
            return toLatLon(x, y, zoneNumber, null, north);
        },
        toUtm: fromLatLon
    }
})();
