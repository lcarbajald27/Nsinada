package pe.gob.oefa.apps.base.webservice.rest.entidad.bean;
...
public class EntidadBean extends BaseBean{
	...
	private RepresentanteBean representanteBean;
	
	public EntidadBean() {
		super();
		this.setRepresentanteBean(new RepresentanteBean());
	}
	...
	public String toString() {
		return "EntidadBean [Id_Persona=" + Id_Persona + ", NombreCompleto=" + NombreCompleto + ", ApellidoMaterno="
				...
				+ super.toString()
		        +this.getRepresentanteBean();
	}

	public RepresentanteBean getRepresentanteBean() {
		return representanteBean;
	}

	public void setRepresentanteBean(RepresentanteBean representanteBean) {
		this.representanteBean = representanteBean;
	}
